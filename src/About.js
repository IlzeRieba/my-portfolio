    ...
    <div className="mt-5">
      ...
      <div class="mt-2 max-width:40%">
        <p>
          ...
          &nbsp;(HTML, CSS, JavaScript, React.js). I continue learning as Junior
          ...
          . I love to design and create websites and work on my passion projects
          with the{" "}
          <a
